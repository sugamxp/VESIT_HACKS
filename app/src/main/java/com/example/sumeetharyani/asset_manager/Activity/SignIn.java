...
import com.example.sumeetharyani.asset_manager.Fragment.ForgetPass;
import com.example.sumeetharyani.asset_manager.GS.Info;
...
public class SignIn extends AppCompatActivity {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (!task.isSuccessful()) {
                                        ...
                                        if(authority.equals("Faculty")) {
                                            ...
                                            Intent i = new Intent(SignIn.this, PurchaseActivity.class);
                                            startActivity(i);
                                            finish();
                                        }
                                    }
    ...
    private void updateUI(FirebaseUser account) {
        if (account != null) {
            ...
            startActivity(i);
            Toasty.success(this, "Sign In Successfull").show();
            finish();
        }
    }
